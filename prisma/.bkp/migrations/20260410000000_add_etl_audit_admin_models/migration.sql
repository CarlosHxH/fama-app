...
-- AlterEnum
BEGIN;
CREATE TYPE "PerfilAdmin_new" AS ENUM ('SUPER_ADMIN', 'FINANCEIRO', 'OPERACIONAL', 'VISUALIZADOR');
ALTER TABLE "admin_users" ALTER COLUMN "perfil" TYPE "PerfilAdmin_new" USING ("perfil"::text::"PerfilAdmin_new");
ALTER TYPE "PerfilAdmin" RENAME TO "PerfilAdmin_old";
ALTER TYPE "PerfilAdmin_new" RENAME TO "PerfilAdmin";
DROP TYPE "public"."PerfilAdmin_old";
COMMIT;
...
-- AlterTable
ALTER TABLE "cobrancas_asaas" RENAME CONSTRAINT "BillingPayment_pkey" TO "cobrancas_asaas_pkey",
ADD COLUMN     "asaasBillingType" TEXT DEFAULT 'PIX',
ADD COLUMN     "boletoDigitableLine" TEXT,
ADD COLUMN     "checkoutUrl" TEXT,
ADD COLUMN     "externalRef" TEXT,
ADD COLUMN     "legacyBoletoId" INTEGER,
ADD COLUMN     "nossoNumero" TEXT,
ADD COLUMN     "numBanco" TEXT,
ADD COLUMN     "parcela" TEXT;

-- AlterTable
ALTER TABLE "contas_oauth" RENAME CONSTRAINT "Account_pkey" TO "contas_oauth_pkey";

-- AlterTable
ALTER TABLE "sessoes" RENAME CONSTRAINT "Session_pkey" TO "sessoes_pkey";

-- AlterTable
ALTER TABLE "usuarios" RENAME CONSTRAINT "User_pkey" TO "usuarios_pkey",
DROP COLUMN "adminStaffRole",
...
-- RenameForeignKey
ALTER TABLE "cobrancas_asaas" RENAME CONSTRAINT "BillingPayment_userId_fkey" TO "cobrancas_asaas_userId_fkey";

-- RenameForeignKey
ALTER TABLE "contas_oauth" RENAME CONSTRAINT "Account_userId_fkey" TO "contas_oauth_userId_fkey";

-- RenameForeignKey
ALTER TABLE "sessoes" RENAME CONSTRAINT "Session_userId_fkey" TO "sessoes_userId_fkey";
...
-- RenameIndex
ALTER INDEX "BillingPayment_asaasPaymentId_key" RENAME TO "cobrancas_asaas_asaasPaymentId_key";

-- RenameIndex
ALTER INDEX "BillingPayment_createdAt_idx" RENAME TO "cobrancas_asaas_createdAt_idx";

-- RenameIndex
ALTER INDEX "BillingPayment_status_idx" RENAME TO "cobrancas_asaas_status_idx";

-- RenameIndex
ALTER INDEX "BillingPayment_userId_idx" RENAME TO "cobrancas_asaas_userId_idx";

-- RenameIndex
ALTER INDEX "Account_provider_providerAccountId_key" RENAME TO "contas_oauth_provider_providerAccountId_key";

-- RenameIndex
ALTER INDEX "Session_sessionToken_key" RENAME TO "sessoes_sessionToken_key";

-- RenameIndex
ALTER INDEX "VerificationToken_identifier_token_key" RENAME TO "tokens_verificacao_identifier_token_key";

-- RenameIndex
ALTER INDEX "VerificationToken_token_key" RENAME TO "tokens_verificacao_token_key";

-- RenameIndex
ALTER INDEX "User_asaasCustomerId_key" RENAME TO "usuarios_asaasCustomerId_key";

-- RenameIndex
ALTER INDEX "User_cpfCnpj_key" RENAME TO "usuarios_cpfCnpj_key";
