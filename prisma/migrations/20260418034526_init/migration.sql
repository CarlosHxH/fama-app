-- CreateEnum
CREATE TYPE "Role" AS ENUM ('ATENDENTE', 'FINANCEIRO', 'ADMIN');
...
-- CreateEnum
CREATE TYPE "SituacaoContrato" AS ENUM ('ATIVO', 'INATIVO', 'QUITADO', 'RESCINDIDO', 'SUSPENSO', 'TRANSFERIDO');
...
CREATE TABLE "jazigos" (
    ...
    "contrato_id" TEXT NOT NULL,
    "responsavel_financeiro_customer_id" TEXT,
    "synced_at" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "created_at" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updated_at" TIMESTAMP(3) NOT NULL,
...
-- CreateTable
CREATE TABLE "tarifas_jazigo" (
    "id" TEXT NOT NULL,
    "quantidade_gavetas" INTEGER NOT NULL,
    "valor_mensalidade" DECIMAL(10,2) NOT NULL,
    "vigente_desde" DATE NOT NULL,
    "decreto_criador" VARCHAR(100),
    "observacoes" TEXT,
    "created_at" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,

    CONSTRAINT "tarifas_jazigo_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "notificacoes" (
    ...
    "erro_detalhe" TEXT,
    "chave_idempotencia" VARCHAR(150),
...
-- CreateIndex
CREATE UNIQUE INDEX "customer_addresses_sql_server_id_key" ON "customer_addresses"("sql_server_id");

-- CreateIndex
CREATE INDEX "customer_addresses_customer_id_idx" ON "customer_addresses"("customer_id");

-- CreateIndex
CREATE UNIQUE INDEX "customer_phones_sql_server_id_key" ON "customer_phones"("sql_server_id");
...
-- CreateIndex
CREATE INDEX "responsaveis_financeiros_customer_id_idx" ON "responsaveis_financeiros"("customer_id");
...
-- CreateIndex
CREATE INDEX "tarifas_jazigo_quantidade_gavetas_vigente_desde_idx" ON "tarifas_jazigo"("quantidade_gavetas", "vigente_desde");

-- CreateIndex
CREATE UNIQUE INDEX "tarifas_jazigo_quantidade_gavetas_vigente_desde_key" ON "tarifas_jazigo"("quantidade_gavetas", "vigente_desde");
...
-- CreateIndex
CREATE INDEX "pagamentos_titular_contrato_id_idx" ON "pagamentos"("titular_contrato_id");
...
-- CreateIndex
CREATE INDEX "pagamentos_asaas_id_idx" ON "pagamentos"("asaas_id");
...
-- CreateIndex
CREATE INDEX "pagamentos_tipo_idx" ON "pagamentos"("tipo");
...
-- CreateIndex
CREATE INDEX "change_requests_tipo_idx" ON "change_requests"("tipo");
...
-- AddForeignKey
ALTER TABLE "responsaveis_financeiros" ADD CONSTRAINT "responsaveis_financeiros_customer_id_fkey" FOREIGN KEY ("customer_id") REFERENCES "customers"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "pagamentos" ADD CONSTRAINT "pagamentos_titular_contrato_id_fkey" FOREIGN KEY ("titular_contrato_id") REFERENCES "customers"("id") ON DELETE SET NULL ON UPDATE CASCADE;
